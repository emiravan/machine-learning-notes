...
sc1=StandardScaler()
E_scaled = sc1.fit_transform(E)
sc2=StandardScaler()
M_scaled =sc2.fit_transform(M)

from sklearn.svm import SVR

svr_reg=SVR(kernel="rbf")
svr_reg.fit(E_scaled,M_scaled)

plt.scatter(E_scaled,M_scaled,color="red")
plt.plot(E_scaled,svr_reg.predict(E_scaled),color="blue")